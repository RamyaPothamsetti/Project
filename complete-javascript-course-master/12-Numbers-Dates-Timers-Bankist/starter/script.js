...
console.log(Math.max(5, 8, 41, 656, 4566, 3121225));
console.log(Math.max(5, 8, 41, 656, 4566, '3121225x'));
console.log(Math.max(5, 8, 41, 656, 4566, '3121225')); //type Coersion
console.log(Math.min(5, 8, 41, 656, 4566, 3121225));
...
const now = new Date();
console.log(now);
console.log(new Date('Nov 15 2022 17:40:22 GMT+0530'));
