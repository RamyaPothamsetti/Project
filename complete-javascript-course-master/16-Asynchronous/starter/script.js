...
//     const getNeighbour = data.borders?.[0];
...
//     request2.open('GET', `https://restcountries.com/v2/alpha/${getNeighbour}`);
...
//       return response.json();
//     })
//     .then(data => renderCountry(data, 'neighnour'))
//     .catch(err => {
//       console.error(`${err} 💥💥💥`);
